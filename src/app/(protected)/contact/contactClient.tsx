...
export default function ContactPageResponsive() {
  ...
  return (
    <div className="w-full min-h-[calc(100vh-57px)] flex flex-col md:flex-row">
      ...
      {/* Formulaire */}
      <div
          className="w-full md:w-2/5 bg-yellowfade/60 p-6 md:p-10 flex flex-col justify-center md:h-auto"
          ...
          {sent ? (
            ...
            >
              ...
              <textarea
                ...
                className="border p-2 rounded font-serif text-gray-800 h-48 md:h-60 placeholder-gray-400 bg-white focus:outline-none focus:ring-2 focus:ring-blue-400 flex-1"
                required
              />
              <button
                type="submit"
                className="bg-powderblue text-white py-2 px-4 rounded hover:bg-powderblue transition mt-2"
              >
                Envoyer
              </button>
              {error && (
                <p className="text-red-600 text-center md:text-left mt-2">
